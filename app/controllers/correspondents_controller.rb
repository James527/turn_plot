class CorrespondentsController < ApplicationController
  ...
  #   respond_to do |format|
  #     format.html { redirect_to root_url, notice: 'Correspondent was successfully destroyed.' }
  ...
  #     @correspondent = Correspondents.find(params[:id])
  #   end

  #   # Never trust parameters from the scary internet, only allow the white list through.
  #   def correspondent_params
  #     params.require(:correspondent).permit(:title, :description)
  #   end
